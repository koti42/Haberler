!function () {
    ...
    var r, n, s = {
        ...
        hotlists: {width: 400, height: 600, isTransparent: !1, dateRange: "12M", showSymbolLogo: !1},
        "market-overview": {width: 400, height: 650, isTransparent: !1, dateRange: "12M", showSymbolLogo: !0},
        "market-quotes": {width: 770, height: 450, isTransparent: !1, showSymbolLogo: !1},
        ...
        "ticker-tape": {isTransparent: !1, displayMode: "adaptive", showSymbolLogo: !1},
    ...
    new class extends class {
        ...
        _getScriptsInfo() {
            const t = function () {
                ...
                for (let e = 0; e < t.length; e++) if ("interactive" === t[e].readyState) return t[e].src;
                try {
                    throw new Error
                } catch (t) {
            ...
            const {host: e, href: r} = i(t), n = document.getElementsByTagName("script"), s = [];
        ...
        _replaceScript(e) {
            ...
            const h = "32px", l = isNaN(this.settings.height) ? this.settings.height : this.settings.height + "px",
            ...
            const p = a && !this.settings.whitelabel, m = this.hasCopyright ? `calc(${l} - 32px)` : l;
