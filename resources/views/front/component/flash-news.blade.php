      ...
      <div class="card bg-dark text-white">
        <div class="card-body">
          ...
          >
            ...
            <div class="rotate-img">
              <img
                src="{{asset('front/assets/images/dashboard/home_2.jpg')}}"alt="thumb"class="img-fluid img-lg"/>
            </div>
          </div>
          ...
          >
            ...
            <div class="rotate-img">
              <img
                src="{{asset('front/assets/images/dashboard/home_3.jpg')}}"alt="thumb"class="img-fluid img-lg"/>
            </div>
          </div>
        </div>
      </div>
