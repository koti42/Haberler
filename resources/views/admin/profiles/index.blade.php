                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                     src="/back/images/Profiles/{{$data->ProfilePicture}}"
                                ...
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            <img class="img-circle img-bordered-sm" src="{{asset('back/dist/img/user2-160x160.jpg')}}" alt="user image">
                                            <span class="username">
                        ...
                        <span class="bg-success">
                          3 Jan. 2014
                                ...
                                <div class="tab-pane" id="settings">
                                    <form action="{{route('profilesCreate')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">İsim</label>
                                            <div class="col-sm-10">
                                                <input type="name" class="form-control" value="{{$data->name}}"  name ="name" id="inputName" placeholder="İsim">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Pozisyon</label>
                                            <div class="col-sm-10">
                                                <input type="name" class="form-control"value="{{$data->position}}" name="Position" id="inputPozisyon" placeholder="Editor">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control"value="{{$data->email}}" name="email" id="inputEmail" placeholder="Email">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="picture" class="col-sm-2 col-form-label">Profil Fotoğrafı</label>
                                            <div class="col-sm-10">
                                                <input type="hidden" name="old_file" value="{{$data->ProfilePicture}}">
                                                <img width="160" height="160" src="/back/images/Profiles/{{$data->ProfilePicture}}" alt="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputExperience" class="col-sm-2 col-form-label">Tecrübeler</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="inputExperience"name="experience" placeholder="Tecrübeler">{{$data->Experience}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
